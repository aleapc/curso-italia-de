...
if (typeof localStorage !== 'undefined' && curso.sku === 'curso-espanha-de') {
  try {
...
export const PROFILES: { id: Profile; nome: string; emoji: string }[] = [
  { id: 'ale', nome: 'Du', emoji: '🧳' },
  { id: 'dea', nome: 'Reisebegleitung', emoji: '🕶️' }
];
...
function save() {
  ...
  try {
    ...
    console.warn('Dime: Fortschritt konnte nicht gespeichert werden (Speicher voll?)', e);
  }
}
